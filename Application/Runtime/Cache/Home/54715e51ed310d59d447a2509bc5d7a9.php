      ...
      <style>
		...
		.foot{
			...
			line-height:30px;
					...
					.list .eight .block .sub .pic{
						width:100%;
						height:100px;
					}
					.list .eight .block .sub img{
						width:100%;
						height:100px;
					}
					.list .eight .block .sub .span{
...
<div class="head">
    ...
    <div class="menu">
    	<a href="<?php echo U('Index/index');?>"><button>首页</button></a>
    	<a href="<?php echo U('Index/hot');?>"><button style="background-color:blue;">热推</button></a>
    	<a href="<?php echo U('Index/mgoods');?>"><button>商品</button></a>
    	<a href="<?php echo U('Index/mservice');?>"><button>服务</button></a>
	</div>
	<div class="list">	
	    <div class="search">
...
<script type="text/javascript">
 ...
 function search()
 {
	...
	window.location.href="<?php echo U('Index/hot');?>?con="+condition; 
